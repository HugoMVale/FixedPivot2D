...
CASE (1)
    ...
    OPEN (UNIT=1, FILE="./output/F.dat", STATUS="REPLACE", ACTION="WRITE", POSITION="REWIND")
    OPEN (UNIT=2, FILE="./output/Moments.dat", STATUS="REPLACE", ACTION="WRITE", POSITION="REWIND")
    OPEN (UNIT=3, FILE="./output/Fdiag.dat", STATUS="REPLACE", ACTION="WRITE", POSITION="REWIND")
